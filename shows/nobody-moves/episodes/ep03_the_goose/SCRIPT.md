...
To use your own take for a line, save it as `recordings/<name>.m4a` (or .wav/.mp3) in this episode folder, using the name shown next to the line. 0 of 27 lines are recorded.

## Script

### 0:00.00–0:04.82 · HOOK
EXTREME CLOSE-UP: Lorraine in the bumblebee costume.

> Lower third: **LORRAINE**, Porch goose · Front steps, No. 7, *Wearing: the bumblebee (she says)*

**LORRAINE** (0:00.00) · record as `hook_1`: That night? I was wearing the bumblebee, hon.

**LORRAINE** (0:02.87) · record as `hook_2`: I remember, because it itches.
