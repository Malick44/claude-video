...
The series library lives in `stills/`: `garrison`, `porch`, `holes`, `yard_before`, `yard_after`, `aerial` (the cul-de-sac from above, behind every title card), `lorraine` (her interview close-up), `chime`, `basin_counsel` (Mr. Basin with his briefcase), `ray` (under grey skies), `lorraine_bee` and `lorraine_easter` (the `lorraine` close-up in two of her outfits), `cork` (the evidence board), the derived doorbell frame `yard_gone` (frame 428 on), `ray_night` (Ray at night with his light on, derived from `ray` by `episodes/ep04_only_when_its_sunny/make_stills.py`), and the derived doorbell frame `yard_shadow` (frame 343, made by `episodes/ep05_saturday/make_stills.py`). Every episode can use it.
...
- Ep. 5: `lorraine_fitting` (an edit of `lorraine` in a half-pinned muslin outfit with a tape measure) and `mower` (the Mower's long shadow across the dawn lawn). Until then Lorraine appears plain and the Mower is `episodes/ep05_saturday/stills/mower_shadow.webp`, a shadow painted onto `holes`.
...
| 1 | Garrison says he "was facing the other way." | repeated in Ep. 2 ("He would like that on the record"); in Ep. 4's frame 431 it becomes literal: he turned away from Deb at 03:12:21. Ep. 5: "A gentleman turns around, kid." From the fitting |
...
| 3 | **Hidden:** in frame 428 (03:12:16), **the porch step is empty: Lorraine is gone.** She's there in frame 427, a second earlier. The goose who "doesn't go anywhere" left the porch 16 seconds after Deb moved. | **confirmed in Ep. 4** (replay: "LORRAINE LEFT."). Where she went, Ep. 5: "I was at a fitting, hon." "You have to look nice for Saturday." Her tailor: "A professional, hon. Very discreet." Still open: **who dresses the goose?** |
...
| 4 | **Hidden:** in frame 431 (03:12:21), **Garrison has turned around**: mirrored, he faces away from Deb. He faces her in frame 430, a second earlier. Five seconds after Lorraine left, the gnome who "was facing the other way" turned the other way. | **paid off in Ep. 5** (replay: "GARRISON TURNED."): he turned around to give Lorraine privacy at her fitting |
| 5 | **Saturday: the Mower**, the street's most feared event, shown only as a shadow. Every Saturday it picks everyone up and puts them back, "never three feet off." Mr. Basin is emptied and scrubbed weekly ("My client does not discuss Saturday." "Objection."). Garrison: "Thirty-one years of Saturdays. I've never once looked." | running gag. Deb's three feet is not the Mower's work: it happened at 3:12 AM on a Sunday |
| 5 | **Hidden:** in frame 343 (03:10:00), two minutes before Deb moved, **a long, rounded shadow reaches across the lawn from the left edge**: something off-frame stood up under the street light. It's not in frame 342, a second earlier, and it's gone by frame 417 (03:11:59). | unrevealed; pay off early in Ep. 6 (the inflatable's timer, set for 3:10 AM) |
...
|---|---|---|---|
| 342 | 03:09:56–59 | Everything in place (as 417) | `yard_before` |
| 343 | 03:10:00 | **A long, rounded shadow across the lawn** from something off-frame left | `yard_shadow` (library; made by `ep05_saturday/make_stills.py`) |
| 417 | 03:11:59 | Everything in place; the shadow is gone | `yard_before` |
...
5. **Saturday** (written). Pays off Ep. 4's frame 431 ("GARRISON TURNED."): "A gentleman turns around, kid." From what? "The fitting." Lorraine was at a fitting at 3:12 AM ("You have to look nice for Saturday"; her tailor is "a professional, very discreet"). A reenactment of The Mower, shown only as a shadow: every Saturday it picks everyone up and puts them back, never three feet off. New clue: frame 343 (03:10:00), a shadow on the lawn.
6. **The Inflatable.** Pays off Ep. 5's frame 343 early: the shadow belongs to the holiday inflatable nobody took down, off-frame next door. It has an airtight alibi ("I was flat from 11 to 6"). Then its timer turns up, set for 3:10 AM. A possible thread for the finale: its shadow is gone by 03:11:59, one second before Deb moved. Did it go down, onto Deb?
